...
const getIcon = document.querySelector(
  ".header .inner-wrap .inner-title li:last-child a i"
);
...
getSection.forEach(section => {
    window.addEventListener("scroll",() => {
        ...
        const offsetT = section.offsetTop - 300;
        const offsetH = section.offsetHeight + 300;
        if(top >= offsetT && top < offsetH+offsetT){
